...
export default function ProfilePage() {
  ...
  const toggleLookingFor = (asp: string) => {
    setLookingFors((prev) =>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-brand-50 via-white to-indigo-50 dark:from-slate-900 dark:via-slate-900 dark:to-slate-900 py-10 px-4">
      <div className="max-w-2xl mx-auto">
        <div className="mb-6">
          <h1 className="text-2xl font-bold text-content">Your profile</h1>
          <p className="text-content-tertiary">Update your details to improve recommendations.</p>
        </div>

        <form onSubmit={handleSubmit} className="bg-surface rounded-2xl shadow-lg border border-line-light p-8 space-y-6">
          {/* First Name */}
          <div>
          ...
          {success && <p className="text-sm text-green-600 dark:text-green-300 bg-green-50 dark:bg-green-950 rounded-lg px-3 py-2">{success}</p>}
