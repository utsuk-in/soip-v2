...
export default function OnboardingPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-brand-50 via-white to-indigo-50 py-12 px-4">
      <div className="max-w-xl mx-auto">
        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold text-gray-900 mb-2">Tell us about yourself</h1>
          <p className="text-gray-500">This helps SOIP find the best opportunities for you.</p>
        </div>
