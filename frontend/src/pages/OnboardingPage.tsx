...
export default function OnboardingPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-brand-50 via-stone-50 to-accent-50 dark:from-stone-950 dark:via-stone-900 dark:to-stone-950 py-12 px-4 relative overflow-hidden">
      ...
      <div className="max-w-xl mx-auto relative z-10">
        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold text-stone-900 dark:text-stone-100 mb-2 font-display">Tell Us About You</h1>
          <p className="text-stone-400 dark:text-stone-500">This helps SOIP find the best opportunities for you.</p>
        </div>
