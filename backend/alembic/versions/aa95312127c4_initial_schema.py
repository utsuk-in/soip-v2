...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_opportunities_category", "opportunities", ["category"], unique=False
    )
    op.create_index(
        "ix_opportunities_deadline", "opportunities", ["deadline"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_user_alerts_user_id"), "user_alerts", ["user_id"], unique=False
    )
    op.create_table(
        "chat_messages",
        sa.Column("id", sa.UUID(), nullable=False),
...
def downgrade() -> None:
    ...
    op.drop_index(
        "ix_opportunities_fts", table_name="opportunities", postgresql_using="gin"
    )
    op.drop_index(
        "ix_opportunities_embedding_hnsw",
